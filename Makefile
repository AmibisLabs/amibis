...
import-javadoc:
	cd ../jOMiSCID/ && ant javadoc
	find download/doc-java/javadoc/ -type f -not -wholename '*/.svn*' -exec rm {} \;
	cd ../jOMiSCID/dist/ && find javadoc \( -type d -exec mkdir -p ../../OMiSCID-WebSite/download/doc-java/{} \; \) -o \( -type f -exec cp {} ../../OMiSCID-WebSite/download/doc-java/{} \; \)
